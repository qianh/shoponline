...
<c:if test="${not empty loginUser }">
         欢迎  <font color="red">${loginUser.nickname}</font> 用户登录系统&nbsp;
    <a href="<%=request.getContextPath() %>/product.do?method=list">网上商城</a>&nbsp;
    <a href="<%=request.getContextPath() %>/user.do?method=updateSelfInput">修改个人信息</a>&nbsp; 
    <a href="<%=request.getContextPath() %>/user.do?method=show&id=${loginUser.id}">查询个人信息</a>&nbsp;
